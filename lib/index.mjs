...
function deepPartialify(schema) {
    if (schema instanceof ZodObject) {
        ...
        return ZodUnion.create(options.map((option) => deepPartialify(option)));
    }
    else if (schema instanceof ZodDiscriminatedUnion) {
        const types = Object.values(schema.options);
        ...
        return ZodDiscriminatedUnion.create(discriminator, newTypes);
    }
        ...
        try {
            types.forEach((type) => {
                ...
                if (schema instanceof ZodLiteral) {
                    ...
                    schema.options.forEach((value) => options.set(value, type));
