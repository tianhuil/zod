...
export declare function deepPartialify<T extends ZodTypeAny>(schema: T): partialUtil.DeepPartial<T>;
...
export declare type ZodDiscriminatedUnionOption<Discriminator extends string, DiscriminatorValue extends Primitive> = ZodObject<{
    [key in Discriminator]: ZodLiteral<DiscriminatorValue> | ZodEnum<[
